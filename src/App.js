...
import UserLocation from './Component/UserLocation.js';
...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(position => {
        ...
        //Weather Api call
        Axios.get(`http://api.weatherstack.com/current?access_key=0713ff5b232c2944d6864479e41b757d&query=${this.state.userPosition.latitude},${this.state.userPosition.longitude}`).then(res => {
  ...
  changeLocation = (e) => {
    ...
    Axios.get(`http://api.weatherstack.com/current?access_key=0713ff5b232c2944d6864479e41b757d&query=${this.state.regionInput}`).then(res => {
